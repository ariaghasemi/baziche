...
export type ErrorCode =
  ...
  | 'INVALID_EMAIL' | 'EMAIL_TAKEN' | 'CODE_COOLDOWN' | 'CODE_EXPIRED' | 'INVALID_CODE'
  | 'EMAIL_NOT_VERIFIED' | 'MAX_ATTEMPTS_EXCEEDED'
  ...
  | 'ASSET_TOO_LARGE' | 'ASSET_TYPE_BLOCKED' | 'ASSET_NOT_FOUND' | 'STORAGE_QUOTA_EXCEEDED' | 'STORAGE_MODE'
